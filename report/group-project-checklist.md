---
title: "Group Assignment: Submission Checklist"
---
...
- Phung Nguyen 101739681
- Tu Nhi Luong 101770844
- Trung Nguyen 1023400
...
Tick this box if your group allows using the project in a study where generative AI tools are used to evaluate the design quality of the submission:

- [ ] My group is ok with this project being used in a study where generative AI tools are used to evaluate the design quality of course submissions.

Course staff will evaluate your project either way; ticking the box only allows AI tools to surface aspects of your design that staff might miss and helps us understand to what extent AI tools could be used in evaluating such submissions and providing feedback on them.